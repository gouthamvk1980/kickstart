...
beforeEach(async () => {
    ...
    // [campaignAddress] assigns the first address from the array returned from the method call to campaignAddress
...
describe('Campaigns', () => {
    ...
    it('processes requests', async () => {
        ...
        .createRequest('Testing 123', web3.utils.toWei('5','ether'), accounts[1]).send({
            from: accounts[0],
            gas: '1000000'
        });
        ...
        console.log('Balance in accounts[1] is '+balance);
        assert(balance > 102);
    });
